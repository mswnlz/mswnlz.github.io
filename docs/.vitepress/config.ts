...
export default defineConfig({
  ...
  head: [
    ...
    // 说明：本站为单一简体中文站点，未配置 hreflang。Google 官方建议单语站点省略 hreflang，
    // 面向全球华语用户的语言/地区信号已通过 og:locale:alternate 与 inLanguage 表达。
