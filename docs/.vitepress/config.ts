...
export default defineConfig({
  ...
  themeConfig: {
    socialLinks: [
      ...
      { icon: 'x', link: 'https://x.com/gxjdian', ariaLabel: 'X (Twitter)' },
      {
        icon: {
