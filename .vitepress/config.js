...
export default defineConfig({
  ...
  head: [
    ['script', { async: true, src: 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2634092855285462', crossorigin: 'anonymous' }]
  ],
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      { text: '所有资源', link: '/AIknowledge/' }
    ],
    search: {
      provider: 'local'
    },
